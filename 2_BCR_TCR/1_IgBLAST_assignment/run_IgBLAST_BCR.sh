...
# BSUB -o igblast-%J_%I-output.log
# BSUB -e igblast-%J_%I-error.log
# BSUB -q "normal"
...
input_fasta=/lustre/scratch126/opentargets/opentargets/OTAR2064/working/slemap/singlecell/cellranger/${this_sample}/per_sample_outs/${this_sample}/vdj_b/filtered_contig.fasta
input_annotations=/lustre/scratch126/opentargets/opentargets/OTAR2064/working/slemap/singlecell/cellranger/${this_sample}/per_sample_outs/${this_sample}/vdj_b/filtered_contig_annotations.csv

outdir=/nfs/users/nfs_c/cs54/OTAR2064_cs54/2_IgBLAST_assignment/final_data/IgBLAST_output_BCR
...
AssignGenes.py igblast -s ${input_fasta} -b /nfs/users/nfs_c/cs54/igblast_databases_nov24/igblast \
   --organism human --loci ig --format blast --outdir ${outdir} --outname ${this_pool} --exec ~/my_software/ncbi-igblast-1.22.0/bin/igblastn
